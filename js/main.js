...
function initMobileMenu() {
    ...
    // PREVENT DUPLICATES: Check if we already attached the listener
    if (menuBtn.getAttribute('data-init') === 'true') return;

    // Mark as initialized so we don't add listeners twice
    menuBtn.setAttribute('data-init', 'true');
